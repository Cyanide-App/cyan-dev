declare const languages: {
    ...
    readonly "ja-JA": "Japanese";
    readonly "zh-CN": "Chinese";
    readonly "hi-HI": "Hindi";
    readonly "ar-AR": "Arabic";
    readonly "jv-JV": "Javanese";
    readonly "ben-BEN": "Bengali";
    readonly "ru-RU": "Russian";
    readonly "de-GER": "German";
    readonly "ko-KO": "Korean";
    readonly "af-FR": "French";
};

type Language = keyof typeof languages;
type PlatformId = "3do" | "arcade" | "atari2600" | "atari5200" | "atari7800" | "jaguar" | "lynx" | "mame2003" | "nes" | "n64" | "nds" | "gba" | "gb" | "psx" | "sega32x" | "segaCD" | "segaGG" | "segaMS" | "segaMD" | "segaSaturn" | "snes" | "vb" | "pce" | "pcfx" | "ngp" | "ws" | "coleco" | "c64" | "amiga";
type CoreName = "opera" | "fbneo" | "fbalpha2012_cps1" | "fbalpha2012_cps2" | "stella2014" | "a5200" | "prosystem" | "virtualjaguar" | "handy" | "mame2003" | "fceumm" | "nestopia" | "mupen64plus_next" | "melonds" | "desmume2015" | "mgba" | "gambatte" | "mgba" | "mednafen_psx" | "pcsx_rearmed" | "picodrive" | "genesis_plus_gx" | "picodrive" | "genesis_plus_gx" | "genesis_plus_gx" | "picodrive" | "genesis_plus_gx" | "picodrive" | "yabause" | "snes9x" | "beetle_vb" | "mednafen_pce" | "mednafen_pcfx" | "mednafen_ngp" | "mednafen_wswan" | "gearcoleco" | "vice_x64" | "puae";
type BiosName = "panafz1.bin" | "panafz10.bin" | "panafz10-norsa.bin" | "panafz10e-anvil.bin" | "panafz10e-anvil-norsa.bin" | "panafz1j.bin" | "panafz1j-norsa.bin" | "goldstar.bin" | "sanyotry.bin" | "3do_arcade_saot.bin" | "7800 BIOS (U).rom" | "lynxboot.img" | "disksys.rom" | "gamegenie.nes" | "bios7.bin" | "bios9.bin" | "firmware.bin" | "dsi_bios7.bin" | "dsi_bios9.bin" | "dsi_firmware.bin" | "dsi_nand.bin" | "dsi_sd_card.bin" | "gb_bios.bin" | "gbc_bios.bin" | "gba_bios.bin" | "sgb_bios.bin" | "scph5500.bin" | "scph5501.bin" | "scph5502.bin" | "PSXONPSP660.bin" | "scph101.bin" | "scph7001.bin" | "scph1001.bin" | "bios_CD_E.bin" | "bios_CD_U.bin" | "bios_CD_J.bin" | "bios.gg" | "bios_E.sms" | "bios_U.sms" | "bios_J.sms" | "bios_MD.bin" | "saturn_bios.bin" | "BS-X.bin" | "STBIOS.bin";
type MainOptions = {
    /**
     * URL to ROM file.
...
type CoresOptions = [
    ...
    },
    {
         ...
         */
        EJS_core: Extract<PlatformId, "arcade"> | Extract<CoreName, "fbneo" | "fbalpha2012_cps1" | "fbalpha2012_cps2">;
    },
    {
        /**
    ...
    },
    {
         ...
         */
        EJS_core: Extract<PlatformId, "nes"> | Extract<CoreName, "fceumm" | "nestopia">;
    ...
    },
    {
         ...
         */
        EJS_core: Extract<PlatformId, "nds"> | Extract<CoreName, "melonds" | "desmume2015">;
        /**
    ...
    },
    {
         ...
         */
        EJS_core: Extract<PlatformId, "psx"> | Extract<CoreName, "mednafen_psx" | "pcsx_rearmed">;
        EJS_biosUrl?: string;
    },
    {
        /**
    ...
    },
    {
         ...
         */
        EJS_core: Extract<PlatformId, "segaCD"> | Extract<CoreName, "genesis_plus_gx" | "picodrive">;
        EJS_biosUrl?: string;
    },
    {
        /**
         ...
         */
        EJS_core: Extract<PlatformId, "segaGG"> | Extract<CoreName, "genesis_plus_gx">;
        EJS_biosUrl?: string;
    },
    {
        /**
         ...
         */
        EJS_core: Extract<PlatformId, "segaMS"> | Extract<CoreName, "genesis_plus_gx" | "picodrive">;
        EJS_biosUrl?: string;
    },
    {
        /**
         ...
         */
        EJS_core: Extract<PlatformId, "segaMD"> | Extract<CoreName, "genesis_plus_gx" | "picodrive">;
        EJS_biosUrl?: string;
    },
    {
        /**
...
type Settings = MainOptions & GameOptions & DebugOptions & CoresOptionsCommon & CoresOptions[number] & AdvancedOptions;
type EJS_core = Settings["EJS_core"];
type Bios = {
    name: BiosName;
...
type BiosesUrls = Record<BiosName, string | undefined>;

type Props = {
    width?: number;
    height?: number;
} & Settings;
declare const EmulatorJS: React.FunctionComponent<Props>;

declare const platforms: Platform[];

declare const defaultBiosesUrls: BiosesUrls;

declare const cdnPathToDataUrls: readonly ["https://cdn.emulatorjs.org/stable/data", "https://cdn.emulatorjs.org/latest/data", "https://cdn.emulatorjs.org/nightly/data"];
declare const defaultPathToData: "https://cdn.emulatorjs.org/stable/data";

declare const getPlatforms: (biosesUrls?: BiosesUrls) => {
    bioses: {
        url: string | undefined;
        name: BiosName;
        description: string | undefined;
...
declare const isBios: (value: unknown) => value is Bios;
declare const findCoreBioses: (core: EJS_core, biosesUrls?: BiosesUrls) => {
    url: string | undefined;
    name: BiosName;
    description: string | undefined;
}[] | undefined;

export { Bios, BiosName, CoreName, EJS_core, EmulatorJS, Language, PlatformId, Settings, cdnPathToDataUrls, defaultBiosesUrls, defaultPathToData, findCoreBioses, getPlatforms, isBios, languages, platforms };
